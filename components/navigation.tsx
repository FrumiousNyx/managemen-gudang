...
export function Navigation() {
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex items-center px-4 py-2 rounded-xl text-sm font-medium text-slate-600 dark:text-zinc-300 hover:bg-slate-100 dark:hover:bg-zinc-800 hover:text-slate-900 dark:hover:text-zinc-100 transition-all duration-200 active:bg-slate-200 dark:active:bg-zinc-700"
  ...
  return (
    <nav className="sticky top-0 z-50 backdrop-blur-md bg-white/80 dark:bg-zinc-900/80 border-b border-slate-200 dark:border-zinc-800">
        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-2">
            ...
            <div className="relative md:hidden">
              <button
                ...
                className="inline-flex items-center justify-center p-2 rounded-xl text-slate-600 dark:text-zinc-300 hover:bg-slate-100 dark:hover:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-slate-900 dark:focus:ring-zinc-100"
              ...
              {showNotifications && (
                <div className="absolute left-0 mt-2 w-80 bg-white dark:bg-zinc-950 rounded-xl shadow-lg border border-slate-200 dark:border-zinc-800 z-50" data-notification-dropdown>
                  ...
                  <div className="max-h-96 overflow-y-auto">
                    {lowStockProducts.length === 0 ? (
                      <div className="p-4 text-center text-slate-600 dark:text-zinc-300">
                  ...
                  {lowStockProducts.length > 0 && (
                    <div className="p-3 border-t border-slate-200 dark:border-zinc-800">
                      <Link
                        href="/products"
                        onClick={() => setShowNotifications(false)}
                        className="block text-center text-sm text-slate-600 dark:text-zinc-300 hover:text-slate-900 dark:hover:text-zinc-100"
                      >
                        Lihat Semua Produk
                      </Link>
                    </div>
            ...
            <button
              ...
              className="md:hidden inline-flex items-center justify-center p-2 rounded-xl text-slate-600 dark:text-zinc-300 hover:bg-slate-100 dark:hover:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-slate-900 dark:focus:ring-zinc-100 active:bg-slate-200 dark:active:bg-zinc-700"
              title={theme === 'dark' ? 'Mode Terang' : 'Mode Gelap'}
            >
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative hidden sm:block">
              <button
                onClick={() => setShowNotifications(!showNotifications)}
                className="flex items-center px-3 py-2 rounded-xl text-sm font-medium text-slate-600 dark:text-zinc-300 hover:bg-slate-100 dark:hover:bg-zinc-800 hover:text-slate-900 dark:hover:text-zinc-100 transition-all duration-200"
                title="Notifikasi Stok"
              >
              ...
              {showNotifications && (
                <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-zinc-950 rounded-xl shadow-lg border border-slate-200 dark:border-zinc-800 z-50" data-notification-dropdown>
                  <div className="p-4 border-b border-slate-200 dark:border-zinc-800">
                    <h3 className="font-semibold text-slate-900 dark:text-zinc-100 flex items-center gap-2">
                      <AlertTriangle className="h-4 w-4 text-orange-500" />
                      Notifikasi Stok
            ...
            <button
              ...
              className="hidden sm:flex items-center px-3 py-2 rounded-xl text-sm font-medium text-slate-600 dark:text-zinc-300 hover:bg-slate-100 dark:hover:bg-zinc-800 hover:text-slate-900 dark:hover:text-zinc-100 transition-all duration-200 active:bg-slate-200 dark:active:bg-zinc-700"
              title={theme === 'dark' ? 'Mode Terang' : 'Mode Gelap'}
            >
              {theme === 'dark' ? <Sun className="h-4 w-4" /> : <Moon className="h-4 w-4" />}
            </button>
            ...
            <button
              ...
              className="hidden sm:flex items-center px-3 py-2 rounded-xl text-sm font-medium text-slate-600 dark:text-zinc-300 hover:bg-slate-100 dark:hover:bg-zinc-800 hover:text-slate-900 dark:hover:text-zinc-100 transition-all duration-200"
            >
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden border-t border-slate-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 animate-in slide-in-from-top-2 duration-200">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <button
              ...
              className="flex items-center w-full px-4 py-3 rounded-xl text-base font-medium text-slate-600 dark:text-zinc-300 hover:bg-slate-100 dark:hover:bg-zinc-800 hover:text-slate-900 dark:hover:text-zinc-100 transition-all duration-200"
            >
